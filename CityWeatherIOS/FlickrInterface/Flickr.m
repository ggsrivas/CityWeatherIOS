...
{
    return [NSString stringWithFormat:@"https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=%@&text=%@&per_page=1&format=json&nojsoncallback=1",kFlickrAPIKey,searchTerm];
}
